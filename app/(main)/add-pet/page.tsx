...
const AddPetPage = () => {
  return (
    <div className="container min-h-full flex flex-col lg:flex-row gap-2.5 md:gap-4 lg:gap-8 pb-5">
      ...
      <section className="flex items-center justify-center rounded-3xl md:rounded-[60px] bg-white w-full h-auto lg:h-full p-5 pt-7 sm:max-w-[335px] mx-auto md:max-w-[704px]">
        <div className="lg:max-w-[424px]">
          <h2 className="text-neutral-800 text-3xl md:text-5xl font-bold leading-7 md:leading-10 mb-6 md:mb-4">
            Add my pet/{" "}
            <span className="text-zinc-800 text-opacity-40 text-sm font-bold leading-none">
              Personal details
            </span>
          </h2>
